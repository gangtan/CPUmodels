...
| FCOMPP : forall (op1: operand), instr (*Not positive about this one*)
| FCOMIP : forall (op1: operand), instr
| FCOS : forall (op1: operand), instr
| FDECSTP : forall (op1: operand), instr
| FDIV : forall (d: bool)(op1: operand), instr (*clarify d parameter*)
| FDIVP : forall (op1: operand), instr (*is the 1 bit an operand? not sure *)
| FDIVR : forall (d: bool) (op1: operand), instr
...
| FSTSW : forall(op1: operand), instr (*should op1 be an option? *)
| FSUB : forall (d: bool) (op1: operand), instr
| FSUBP : forall (op1: operand), instr
| FSUBR : forall (d: bool) (op1: operand), instr 
