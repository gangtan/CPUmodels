...
(** val nth_ok : Big.big_int -> 'a1 list -> 'a1 -> bool **)
...
(** val nth_in_or_default : Big.big_int -> 'a1 list -> 'a1 -> bool **)

let nth_in_or_default =
(*  failwith "AXIOM TO BE REALIZED" *)
fun _ _ _ -> false

(** val nth_error : 'a1 list -> Big.big_int -> 'a1 coq_Exc **)
...
(** val nth_default : 'a1 -> 'a1 list -> Big.big_int -> 'a1 **)
...
(** val count_occ :
    ('a1 -> 'a1 -> bool) -> 'a1 list -> 'a1 -> Big.big_int **)

let rec count_occ eq_dec l x =
  match l with
  | [] -> Big.zero
  | y :: tl0 ->
    let n = count_occ eq_dec tl0 x in if eq_dec y x then Big.succ n else n
...
(** val firstn : Big.big_int -> 'a1 list -> 'a1 list **)
...
(** val skipn : Big.big_int -> 'a1 list -> 'a1 list **)
...
(** val seq : Big.big_int -> Big.big_int -> Big.big_int list **)
