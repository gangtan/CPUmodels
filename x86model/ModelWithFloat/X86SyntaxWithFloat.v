...
Definition stack_i (top num : Z) :=
  match top with
    | 0 => Z_to_fpu_registeRzero num
    | 1 => Z_to_fpu_registeRone num
    | 2 => Z_to_fpu_registeRtwo num
    | 3 => Z_to_fpu_registeRthree num
    | 4 => Z_to_fpu_registeRfour num
    | 5 => Z_to_fpu_registeRfive num
    | 6 => Z_to_fpu_registeRsix num
    | _ => Z_to_fpu_registeRseven num
  end.
(*
